function [sigma_f_u,sigma_f_l] = comput_sigma_fs(sigma_l,sigma_u)


sigma_f_u = zeros(1,size(sigma_l,1));
sigma_f_l = zeros(1,size(sigma_l,1));

%%%%%%%%
%Class 3
sigma_f_u(3) = sigma_u(3,3);
sigma_f_l(3) = sigma_l(3,3);
...
%Variance:
%sigma23^2
[temp_l,temp_u] = propagate_multi(sigma_l(2,3),sigma_u(2,3),sigma_l(2,3),sigma_u(2,3));
%sigma23^2/sigma33
[temp_l,temp_u] = propagate_div(temp_l,temp_u,sigma_l(3,3),sigma_u(3,3));
%
[sigma_f_l(2),sigma_f_u(2)] = propagate_diff(sigma_l(2,2),sigma_u(2,2),temp_l,temp_u);
...
%summand1 = sigma12 * (sigma12*sigma33 - sigma13*sigma23 )
[summand1_l,summand1_u] = propagate_multi(sigma_l(1,2),sigma_u(1,2),cross1_l,cross1_u);
%summand2 =  sigma13 * (sigma13*sigma22 - sigma12*sigma23 )
[summand2_l,summand2_u] = propagate_multi(sigma_l(1,3),sigma_u(1,3),cross2_l,cross2_u);
%sigma12 * (sigma12*sigma33 - sigma13*sigma23 ) + sigma13 * (sigma13*sigma22 - sigma12*sigma23 )
[temp_l,temp_u] = propagate_sum(summand1_l,summand1_u,summand2_l,summand2_u);
%dividing for determinant
[temp_l,temp_u] = propagate_div(temp_l,temp_u,det_l,det_u);
%Final expression
[sigma_f_l(1),sigma_f_u(1)] = propagate_diff(sigma_l(1,1),sigma_u(1,1),temp_l,temp_u);
